...
#############Defined Strings#############
addon_id     = 'plugin.video.flaxxcomm-gold'
...
Guide = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.flaxxcomm-gold/resources/catchup', 'guide.xml'))
GuideLoc = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.flaxxcomm=gold/resources/catchup', 'g'))
...
##########################################
def catchup():
    loginurl   = "http://ourstreams.com:826/get.php?username=" + username + "&password=" + password + "&type=m3u_plus&output=ts"
    try:
...
def addonsettings(url,description):
	if   url =="CC":
		...
		xbmc.executebuiltin('Runscript("special://home/addons/plugin.video.Flaxxcomm/resources/modules/speedtest.py")')
	elif url =="META":
...
def correctPVR():
	...
	addon = xbmcaddon.Addon('plugin.video.Flaxxcomm-gold')
	...
	loginurl   = "http://ourstreams.com:826/get.php?username=" + username_text + "&password=" + password_text + "&type=m3u_plus&output=ts"
	EPGurl     = "http://ourstreams.com:826/xmltv.php?username=" + username_text + "&password=" + password_text + "&type=m3u_plus&output=ts"
