...
#############Defined Strings#############
addon_id     = 'plugin.video.flaxxcomm-family'
...
Guide = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.flaxxcomm-family/resources/catchup', 'guide.xml'))
GuideLoc = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.flaxxcomm-family/resources/catchup', 'g'))
...
##########################################
def catchup():
    loginurl   = "http://vstreams.tv:25461/get.php?username=" + username + "&password=" + password + "&type=m3u_plus&output=ts"
    try:
...
def addonsettings(url,description):
	if   url =="CC":
		...
		xbmc.executebuiltin('Runscript("special://home/addons/plugin.video.flaxxcomm-family/resources/modules/speedtest.py")')
	elif url =="META":
...
def correctPVR():
	...
	addon = xbmcaddon.Addon('plugin.video.flaxxcomm-family')
	...
	loginurl   = "http://vstreams.tv:25461/get.php?username=" + username_text + "&password=" + password_text + "&type=m3u_plus&output=ts"
	EPGurl     = "http://http://vstreams.tv:25461/xmltv.php?username=" + username_text + "&password=" + password_text + "&type=m3u_plus&output=ts"
